...
func Init() {
	...
	if z3 {
		...
		case app.ModelM2PoE, app.ModelG2HPro, app.ModelM3:
			go z3Worker("Z3GatewayHost_MQTT", "-p", "/dev/ttyS1", "-d", "/data/", "-r", "c")
		case app.ModelG3:
			go z3Worker("Z3GatewayHost_MQTT", "-p", "/dev/ttyS3", "-d", "/data/", "-r", "c")
		case app.ModelM2, app.ModelM1S, app.ModelG2H, app.ModelM1S22:
	...
	if tcp != "" {
		...
		case app.ModelE1, app.ModelMGW2, app.ModelG2HPro, app.ModelM2PoE, app.ModelG3, app.ModelM3:
